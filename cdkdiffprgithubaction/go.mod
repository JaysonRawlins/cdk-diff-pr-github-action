module github.com/JaysonRawlins/cdk-diff-pr-github-action/cdkdiffprgithubaction
...
require (
	...
	github.com/cdklabs/awscdk-asset-awscli-go/awscliv1/v2 v2.2.271 // indirect
