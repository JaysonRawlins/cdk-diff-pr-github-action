  ...
  constructor(props: CdkChangesetScriptProps) {
    ...
    new TextFile(props.project, outputPath, {
      lines: [
        ...
        '',
        '/**',
        ' * Truncate a string value for display, escaping HTML.',
        ' */',
        ...
        ' * - Large values: wrap in collapsible <details>',
        ' */',
        'function formatValue(value: string | undefined, maxLength = 80): string {',
        '  if (!value) return "";',
        '  const escaped = escapeHtml(value);',
        '  if (escaped.length <= maxLength) {',
        '    return `<code>${escaped}</code>`;',
        '  }',
        '  // For large values, show truncated with collapsible full value',
        '  const truncated = escapeHtml(value.slice(0, maxLength)) + "...";',
        '  return `<details><summary><code>${truncated}</code></summary><pre>${escaped}</pre></details>`;',
        '}',
        '',
        '/**',
